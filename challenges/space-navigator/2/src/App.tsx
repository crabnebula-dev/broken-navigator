...
function App() {
  const [loadNavigation, setloadNavigation] = createSignal(
    "The coordinates will show up here when loaded.",
  );
  ...
  return (
    <Layout markdown={readme}>
      <article class="prose prose-invert my-4 xl:prose-lg">
        ...
        <p>
          We need the correct coordinates for Earth, they should be somewhere in
        ...
        <div class="relative w-8/12">
          ...
          >
            ...
            />
            <button
              class="h-10 rounded-r-lg bg-slate-800 px-4 text-base/4"
              type="submit"
            >
              Load via Frontend
            </button>
